...
describe(suite.title, async function (){
    ...
    describe('happy day', async function () {
        ...
        it('interact', async function () {
            CT.querySelector<HTMLElement>(
                '#hypostasis', CT.querySelector('one-page-land', element)).click();
        });
        it('offers the Options Screen', async function () {
            this.retries(16);
            const options: HTMLElement = CT.querySelector('one-page-options', element);
...
describe(suite_url_changed.title, async function (){
    ...
    describe('happy day', async function () {
        ...
        it('interact', async function () {
            ...
            const subject = window as Window & typeof globalThis;
...
describe(suite_vanilla.title, async function (){
    ...
    describe('happy day', async function () {
        ...
        it('opens the Options Screen unprompted', async function () {
            this.retries(64);
            const element: HTMLElement = CT.querySelector('home-page', window);
            const options: HTMLElement = CT.querySelector('one-page-options', element);
            CT.querySelector('#options-form', options);
        });
    });
...
describe(suite_backdrop.title, async function (){
    ...
    describe('happy day', async function () {
        ...
        it('interact: click inside the panel', async function () {
            CT.querySelector<HTMLElement>('#options-title', options).click();
        });
        ...
        it('interact: click on the backdrop', async function () {
            CT.querySelector<HTMLElement>('#options-backdrop', options).click();
        });
